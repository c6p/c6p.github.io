...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5d6c4e8db3d57f16a906693ece2b1dd816ba168060518549d9ff3acbcfde66cb.js',function(){input.required=false;search();});}
